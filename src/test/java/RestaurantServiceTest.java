...
class RestaurantServiceTest {
    ...
    public void searching_for_existing_restaurant_should_return_expected_restaurant_object()
        ...
        assertEquals("Amelie's cafe",
                service.findRestaurantByName("Amelie's cafe").getName());
    }

    // You may watch the video by Muthukumaran on how to write exceptions in Course 3: Testing and Version control:
    // Optional content
    @Test
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        assertThrows(restaurantNotFoundException.class,
                () -> {
                    // Finding a non-existent restaurant named "Hot n Spicy".
                    service.findRestaurantByName("Hot n Spicy");
                });
    }
    //<<<<<<<<<<<<<<<<<<<<SEARCHING>>>>>>>>>>>>>>>>>>>>>>>>>>
